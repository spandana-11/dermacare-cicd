...
public class HelperForConversion {
    ...
    public static SubServicesDto toDto(SubServices entity) {
        ...
        // Optional debug log
        // System.out.println("Mapping SubService ID: " + dto.getSubServiceId() + ", Service ID: " + dto.getServiceId());
    ...
    public static CategoryDto toDto(Category category) {
        ...
        dto.setCategoryId(category.getCategoryId() != null ? category.getCategoryId().toString() : null);
    ...
    public static byte[] base64ToByteArray(String base64String) {
        return base64String != null ? Base64.getDecoder().decode(base64String) : new byte[0];
    }

    public static String byteArrayToBase64(byte[] byteArray) {
        return byteArray != null ? Base64.getEncoder().encodeToString(byteArray) : "";
    }
}