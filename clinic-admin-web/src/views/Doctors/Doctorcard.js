...
const DoctorCard = ({ doctor }) => {
  ...
  const handleToggle = async (e) => {
    ...
    setAvailability(value) // Optimistic UI update
  ...
  {/* Card with View Details button and ID */}
  <div class='main'>
<div className="doctor-action d-flex flex-column align-items-center gap-2 p-2 border rounded shadow-sm">
  ...
  {/* Availability toggle moved INSIDE doctor-action, below button and ID */}
  
</div>
<div className="availability-toggle d-flex align-items-center gap-2 mt-3" style={{ width: '100%', justifyContent: 'center' }}>
    <label htmlFor={`availability-${doctor.doctorId}`} className="fw-bold mb-0" style={{ whiteSpace: 'nowrap' }}>
      Doctor Availability
    </label>
    <CFormSwitch
